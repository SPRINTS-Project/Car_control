...
brn_enu_return_state_t button_initializa_with_int(const button_str_btn_config_t* ptr_str_btn_config , ptr_vfunc ptr_callback);
brn_enu_return_state_t button_enable_INT( button_str_btn_config_t* ptr_str_btn_config);
brn_enu_return_state_t button_disable_INT( button_str_btn_config_t* ptr_str_btn_config);
#endif	/* PUSH_BUTTON_H */
